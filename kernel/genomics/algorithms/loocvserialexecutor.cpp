...
//-------------------------------------------------------------------
// Methods for class LeaveOneOutCVSerialExecutor.
//===================================================================
...
LeaveOneOutCVSerialExecutor::LeaveOneOutCVSerialExecutor() {
...
IMPLEMENTIDMETHODS(LeaveOneOutCVSerialExecutor, LOOCVSERIALEXECUTOR, SerialExecutorLoop)
...
String
LeaveOneOutCVSerialExecutor::GetParameters() const {
...
bool
LeaveOneOutCVSerialExecutor::SetParameter(const String &keyword, const String &value) {
...
bool
LeaveOneOutCVSerialExecutor::InitializeSamplingScheme(const DecisionTable &table, bool masked, const RNG &rng) {
...
bool
LeaveOneOutCVSerialExecutor::SampleTables(int i, const RNG &/*rng*/, DecisionTable &training, DecisionTable &testing, bool masked) const {
...
Structure *
LeaveOneOutCVSerialExecutor::ExecuteCommands(Structure &structure, const Algorithm::Handles &algorithms, const Vector(String) &parameters, ofstream &stream) const {
	...
	LeaveOneOutCVSerialExecutor *self = const_cast(LeaveOneOutCVSerialExecutor *, this);
...
bool
LeaveOneOutCVSerialExecutor::SaveAUCLogStatistics(ofstream &stream, const Vector(float) &statistics, const String &name) const {
...
LeaveOneOutCVSerialExecutor::Clone() {
	return new LeaveOneOutCVSerialExecutor;
} 
