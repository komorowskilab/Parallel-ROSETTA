...
public:
	...
	virtual bool		SetData( double nData );						// set data adding new point
	...
	virtual bool		ClearData(){m_data.RemoveAll() ;return true; }; //jave . Empties data set
	CHMXDataset();
	virtual ~CHMXDataset();
