// dialoggeneralrulepruner.h : header file
//
// Ewa Makosa
...
class CDialogGeneralRulePruner : public CDialogAlgorithm
{
// Construction
public:
	CDialogGeneralRulePruner(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDialogGeneralRulePruner)
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDialogGeneralRulePruner)
	protected:
...
protected:
	...
	//{{AFX_MSG(CDialogGeneralRulePruner)
